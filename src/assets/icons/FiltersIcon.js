export default function FiltersIcon({color}){
    const iconColor = (color)?color:'var(--main-black)';

    return (
        <svg fill={color} height="800px" width="800px" style={{width: 'inherit', height: 'inherit'}} version="1.1" id="Layer_1" viewBox="0 0 512 512" >
            <g>
                <g>
